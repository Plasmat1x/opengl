...
{
    /*
    v0.x = normalize(textureRect.x + textureRect.z, 0, texture.width);
    v0.y = normalize(textureRect.y + textureRect.w, 0, texture.height);

    v1.x = normalize(textureRect.x + textureRect.z, 0, texture.width);
    v1.y = normalize(textureRect.y, 0, texture.height);

    v2.x = normalize(textureRect.x, 0, texture.width);
    v2.y = normalize(textureRect.y, 0, texture.height);
         
    v3.x = normalize(textureRect.x, 0, texture.width);
    v3.y = normalize(textureRect.y + textureRect.w, 0, texture.height);
    */
...
/*
GLfloat Sprite::normalize(GLfloat value, GLfloat minValue, GLfloat maxValue)
{
    GLfloat normValue = 0;
